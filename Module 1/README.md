...
*(Please save the light mode dashboard screenshot as `dashboard.png` in this directory)*

### Dark Mode
![Dashboard Dark Mode](./dashboard-dark.png)
*(Please save the dark mode dashboard screenshot as `dashboard-dark.png` in this directory)*

## Exam Timetable Preview

![Exam Timetable Screenshot](./exam-timetable.png)
*(Please save the exam timetable screenshot as `exam-timetable.png` in this directory)*

## Published Timetable Preview

![Published Timetable Screenshot](./published-timetable.png)
*(Please save the published timetable screenshot as `published-timetable.png` in this directory)*

## Settings & Contributors Preview

### Light Mode
![Settings Light Mode](./settings.png)
*(Please save the settings screenshot as `settings.png` in this directory)*

### Dark Mode
![Settings Dark Mode](./settings-dark.png)
*(Please save the dark mode settings screenshot as `settings-dark.png` in this directory)*
