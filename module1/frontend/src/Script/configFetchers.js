...
const setConfig = async (key, value, onSuccess = () => { }, onFailed = () => { }) => {
    try {
...
const getConfig = async (key, onSuccess = () => { }, onFailed = () => { }) => {
    try {
        const response = await fetch(`${url}/io/config/global/${key}`, {
            headers: {
                'Api-Token': await getApiToken()
...
const deleteConfig = async (key, onSuccess = () => { }, onFailed = () => { }) => {
    try {
        const response = await fetch(`${url}/io/config/global/${key}`, {
            method: 'DELETE',
            headers: {
...
const setConfigLocaly = async (key, value, onSuccess = () => { }, onFailed = () => { }) => {
    try {
...
const getConfigLocaly = async (key, onSuccess = () => { }, onFailed = () => { }) => {
    try {
        const response = await fetch(`${url}/io/config/local/${key}`, {
            headers: {
                'Api-Token': await getApiToken()
...
const deleteConfigLocaly = async (key, onSuccess = () => { }, onFailed = () => { }) => {
    try {
        const response = await fetch(`${url}/io/config/local/${key}`, {
            method: 'DELETE',
            headers: {
