...
const ProfilePage = () => {
    ...
    const handleInputChange = (e) => {
        ...
        // Enforce lowercase only, no spaces for username field
        if (name === 'username') {
    ...
    const handleSave = async (e) => {
        ...
        console.log("Module 1: Attempting update for User ID:", userId);
        ...
        <div className="page profile-page">
            ...
            <div className="profile-twitter-container">
                ...
                <div className="profile-avatar-section">
                    ...
                    {/* Edit Profile / Actions Button - positioned top right like Twitter */}
            ...
            {/* Account Details Card - only visible in edit mode */}
            {isEditing && (
