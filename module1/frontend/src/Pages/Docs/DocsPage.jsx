    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            sections.forEach(section => {
                const sectionTop = section.getBoundingClientRect().top - containerTop + scrollPosition;
        ...
        <div className="docs-container">
            ...
            <main className="docs-content" ref={contentRef}>
                ...
                <section id="introduction" className="docs-section">
                    <span className="docs-badge">ABOUT AEMS</span>
                    <h1>Introduction</h1>
                    <p>The <strong>Automated Examination Management System (AEMS)</strong> is a modern web application that helps institutions create, organize, and publish exam schedules quickly and efficiently.</p>
                    <p>Exam scheduling is a time-consuming task that demands careful planning to avoid conflicts and ensure fairness. Managing timetables manually often leads to errors, overlapping schedules, and wasted effort. To simplify this process, we built AEMS — enabling Coordinators to add subjects, set exam dates and times, detect scheduling conflicts, and share finalized timetables with students and staff.</p>
                    ...
                    <div className="docs-info-card">
                        ...
                        <div className="docs-info-card-content">
                            ...
                            <p>
                                The system is restricted to authorized <strong>Coordinators</strong>. They have exclusive access to critical actions including creating exams, managing users, and publishing schedules, ensuring data integrity.
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section id="getting-started" className="docs-section">
                    ...
                    <div className="alert-box tip">
                        ...
                        <div>
                            <strong>Pro Tip:</strong> Personalize your workspace! You can switch between <strong>Light and Dark modes</strong> and choose your preferred <strong>Accent Color</strong> in the <strong>Settings</strong> page to match your style.
                        </div>
                    </div>
                </section>
                ...
                <section id="authentication" className="docs-section">
                    ...
                    <ul>
                        <li><strong>Username:</strong> Enter your unique username (e.g., <em>lalan.kumar</em>).</li>
                    ...
                    <ul>
                        <li><strong>Step 1: Request Reset:</strong> Click <strong>Forgot password?</strong> on the login page and enter your registered <strong>Email Address</strong>. Click <strong>Send Reset Link</strong>.</li>
                        <li><strong>Step 2: Verify OTP:</strong> Check your email for a 6-digit verification code. Enter it in the <strong>Verification Code</strong> field and click <strong>Verify OTP</strong>.</li>
                        <li><strong>Step 3: Set New Password:</strong> Enter your new password and confirm it. Click <strong>Update Password</strong>.</li>
                        <li><strong>Step 4: Success:</strong> A confirmation screen will appear ("Your password has been reset successfully"). Click <strong>Go to Login</strong> to access your account with the new credentials.</li>
                    </ul>
                ...
                <section id="exam-timetable" className="docs-section">
                    ...
                    <p>The system automatically detects scheduling conflicts:</p>
                    <ul>
                        <li><strong>Visual Alerts:</strong> A "Conflicts Detected" banner appears if exams overlap for the same students.</li>
                        <li><strong>Auto-Resolve:</strong> Click the <strong>Auto-Resolve Conflicts</strong> button to automatically adjust schedules.</li>
                        <li><strong>Conflict Counter:</strong> A badge (e.g., "1 CONFLICT(S)") indicates the number of unresolved issues.</li>
                    </ul>
                ...
                <section id="published-timetable" className="docs-section">
                ...
                <section id="settings" className="docs-section">
                    ...
                    <ul>
                        <li><strong>Appearance:</strong> Switch between <strong>Light</strong>, <strong>Dark</strong>, or <strong>System</strong> modes.</li>
                        <li><strong>Accent Color:</strong> Select your preferred primary color from options like Blue, Purple, Green, Red, or Orange.</li>
                        <li><strong>About Us:</strong> View information about the development team and contributors.</li>
                    </ul>
                </section>
                ...
                <section id="built-with" className="docs-section">
                    ...
                    <div className="alert-box tip">
                        ...
                        <div>
                            <strong>Technology Stack:</strong> AEMS is powered by React, Spring Boot, and MongoDB, ensuring a fast, secure, and scalable experience for managing academic exams.
                        </div>
                    </div>
                </section>
