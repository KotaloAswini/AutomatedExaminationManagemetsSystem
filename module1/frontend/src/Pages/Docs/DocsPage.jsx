        ...
        <div className="docs-container">
            ...
            <main className="docs-content" ref={contentRef}>
                ...
                <section id="authentication" className={`docs-section ${activeSection === 'authentication' ? 'active' : ''}`}>
                    ...
                    <ul style={{ paddingLeft: '1.2rem', margin: '0.5rem 0', display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                        <li><strong>Step 1: Request Reset:</strong> Click <strong>Forgot password?</strong> on the login page, enter your <strong>Email</strong>, and click <strong>Send Reset Link</strong>.</li>
                        <li><strong>Step 2: Verify OTP:</strong> Check your email for a 6-digit code. Enter it and click <strong>Verify OTP</strong>.</li>
                        <li><strong>Step 3: Set New Password:</strong> Type a new password, confirm it, and click <strong>Update Password</strong>.</li>
                        <li><strong>Step 4: Success:</strong> A success message will appear. Click <strong>Go to Login</strong> to sign in with your new password.</li>
                    </ul>
                ...
                <section id="built-with" className={`docs-section ${activeSection === 'built-with' ? 'active' : ''}`}>
                    ...
                    <div className="built-with-grid">
                        ...
                        <div className="tech-card netlify">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="#00C7B7" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
