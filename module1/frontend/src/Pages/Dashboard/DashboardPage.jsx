            ...
            <div className='bottom-section-grid'>
                <div className='dashboard-col'>
                    ...
                    <div className='compact-status-box' style={{ padding: '1.5rem', flexGrow: 1, justifyContent: 'space-between' }}>
                        ...
                        <Link to="/Profile" className='link-sm' style={{ marginTop: '1rem' }}>View Profile</Link>
                    </div>
                    <div className='compact-status-box' style={{ marginTop: 'auto' }}>
                        <div className='status-row'><span className={`dot ${health.backend === 'OK' ? 'success' : 'error'}`}></span> Backend: {health.backend}</div>
                        <div className='status-row'><span className={`dot ${health.db === 'Connected' ? 'success' : 'error'}`}></span> DB: {health.db}</div>
                    </div>
                </div>
