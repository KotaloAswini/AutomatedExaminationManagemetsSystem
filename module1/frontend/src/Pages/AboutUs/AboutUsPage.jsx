                    ...
                    <div className='aboutus-features-section'>
                        ...
                        <div className='aboutus-features-grid'>
                            <div className='aboutus-feature' data-accent='blue'>
                                ...
                                <h3>Create & Manage</h3>
                                <p>Build and modify exam schedules with ease.</p>
                            </div>
                            <div className='aboutus-feature' data-accent='green'>
                                ...
                                <h3>Publish & Share</h3>
                                <p>Instantly distribute timetables to students and staff.</p>
                            </div>
                            <div className='aboutus-feature' data-accent='purple'>
                                ...
                                <h3>Export as PDF</h3>
                                <p>Generate print-ready schedule documents.</p>
                            </div>
                            <div className='aboutus-feature' data-accent='orange'>
                                ...
                                <p>Organize courses, semesters, and exam rules easily.</p>
                            </div>
                        </div>
                    </div>
